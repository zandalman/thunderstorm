...
struct PartData {
  ...
  PartData() = default;
  PartData(size_t num_ener_sec, size_t num_time, size_t num_dis_par, size_t num_dis_perp);
  void reset(int id_, double ener_, size_t num_ener_sec, size_t num_time, size_t num_dis, size_t num_dis_perp);
};
